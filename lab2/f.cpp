...
//    long long t;
//    scanf("%lld",&t);
//    while(t--){//多个cases,一定要记得清零一些变量
//        int n;
//        ans=0;
////        a_1=b_1=a_3=b_3=ans=0;//清零——可以一起清零！
//        scanf("%d",&n);
//        for(int i=0;i<n;i++){
...
//            }
//        }
//        ans-=re;//相等情况下，给魔力的贡献值；re是剩下的a,b个数
//        int b1=0,a1=0;
//        if(size1>0) {//要判断，否则越界//要加一个if条件判断，当size>0的时候才进行
//            merge_sort(_b, 0, size1 - 1, 1);
//            b1 = _b[0].x, a1 = _b[0].y;//有可能读入上一次
//        }
...
//        }
//        int b3=0,a3=0;
//        if(size3>0) {//要加一个if条件判断，当size>0的时候才进行
//            merge_sort(_a,0,size3-1,-1);
//            b3=_a[0].x,a3=_a[0].y;//有可能读入上一次
//        }

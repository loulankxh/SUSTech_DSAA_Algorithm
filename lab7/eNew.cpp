...
//}
//void update(int u,int flag1,int flag2) {
//    if (flag1) {
//        int tmp = 0;
//        while (u != 0 && flag1) {
...
//            else nodes[u].lh = 0;
//            tmp = nodes[u].h;
//            nodes[u].h = nodes[u].rh > nodes[u].lh ? nodes[u].rh : nodes[u].lh;
//            if (tmp == nodes[u].h)flag1 = 0;//end
//            u = nodes[u].fa;
//        }
//    }
//    if (flag2) {
//        while (u != 0) {
//            if (nodes[u].right != 0)
//                nodes[u].rnum = nodes[nodes[u].right].lnum + nodes[nodes[u].right].rnum+1;//itself
//            else
//                nodes[u].rnum = 0;
//            if (nodes[u].left != 0)
//                nodes[u].lnum = nodes[nodes[u].left].lnum + nodes[nodes[u].left].rnum+1;
//            else nodes[u].lnum = 0;
//            u = nodes[u].fa;
//        }
//    }
...
//    if (nodes[u].right != 0){
//        nodes[u].rh = nodes[nodes[u].right].h + 1;
//        nodes[u].rnum=nodes[nodes[u].right].lnum+nodes[nodes[u].right].rnum+1;
//    }
//    else {
//        nodes[u].rh=0;
//        nodes[u].rnum=0;
//    }
//    if (nodes[u].left != 0){
//        nodes[u].lh = nodes[nodes[u].left].h + 1;
//        nodes[u].lnum=nodes[nodes[u].left].lnum+nodes[nodes[u].left].rnum+1;
//    }
//    else {
//        nodes[u].lh=0;
...
//                    nodes[u].rnum=nodes[temp].lnum;
//                    nodes[nodes[temp].right].fa=nodes[u].fa;
//                    nodes[nodes[u].fa].left=nodes[temp].right;
//                    nodes[nodes[u].fa].lnum=nodes[temp].rnum;
//                    nodes[temp].right=nodes[u].fa;
//                    nodes[nodes[u].fa].fa=temp;
//                    nodes[temp].left=u;
//                    nodes[u].fa=temp;
//                    nodes[temp].fa=tmp;
//                    nodes[temp].lnum=nodes[u].lnum+nodes[u].rnum+1;
//                    nodes[temp].rnum=nodes[nodes[temp].right].lnum+nodes[nodes[temp].right].rnum+1;
//                    if(tmp==0)root=temp;
...
//    return ans;
//}
//void delete1(long long val){//3logn
//    int u=root;
